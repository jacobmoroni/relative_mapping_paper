...
\author{Jacob M. Olson$^{1}$, Nathan Toombs, Timothy W. McLain$^{2}$% <-this % stops a space
\footnote{Thanks to Mathieu Labbe for being responsive to answering questions on the RTAB-Map forum and helping with developing the map merging node.}% <-this % stops a space
